...
class VacinacaoModel {
	...
	public function paginacaoVacinacao($paginaatual = 1, $totalregistrospg = 10){
		$paginaatual = ($paginaatual <= 0) ? 1 : $paginaatual; 

		$inicial = ($paginaatual-1) * $totalregistrospg;

		//$query = "SELECT * FROM vacinacoes order by id_vacina_animal LIMIT $inicial, $totalregistrospg";
