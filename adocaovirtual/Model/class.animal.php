...
class AnimalModel {
	...
	public function inserirAnimal() {
		...
		dt_nascimento,nome,cor,raca,procedencia,sexo,porte, nome_imagem, tipo) VALUES(
	...
	public function editarAnimal() {
		...
		nome_imagem='".$this->getNome_imagem()."',		 tipo='".$this->getTipo()."'
	...
	public function listarAnimalPaginacao($paginaatual = 1, $totalregistrospg = 9){
      	$paginaatual = ($paginaatual <= 0) ? 1 : $paginaatual; 
		
        $inicial = ($paginaatual-1) * $totalregistrospg;
		
		$query = "SELECT * FROM animais ORDER BY id_animal LIMIT $inicial, $totalregistrospg";
