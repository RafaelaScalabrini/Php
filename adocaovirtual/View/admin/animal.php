...
<div class="formulario">
	<form name="form_animal" id="form_animal" method="post" action="animal.php" enctype="multipart/form-data">			
		...
		<fieldset>			
			...
			<div class="radio">
				Sexo<br>
		    	<input type="radio" name="sexo" id="masculino" value="M" <?php if ($animal->getSexo() == "M") { ?>checked="checked"<?php } ?> />Masculino<br>
				<input type="radio" name="sexo" id="feminino"  value="F" <?php if ($animal->getSexo() == "F") { ?>checked="checked"<?php } ?> />Feminino<br>
			</div>
